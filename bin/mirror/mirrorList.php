...
<: $last_changed = "<?php echo date('Y-M-d H:i'); ?> - mirrorList" :>//

#include "header.epl"

<!-- This output is autogenerated, do not edit manually. To update, use the
     ProFTPD Mirror Maintenance system at http://mirrors.proftpd.org/. -->

<table bgcolor="white">
<tr>
  <td>
    <div class="headline">
      <: print "<b>$html_title</b>" :>//
    </div>
...
<?php endif; ?>
    ...
    <dl>
      <dt>Official Distribution Site</dt>
      <dd>
        <a href="ftp://ftp.proftpd.org/">ftp://ftp.proftpd.org/</a>
        <br />
        &nbsp;
      </dd>
